...
static void on_Laplacian(int, void*);//拉普拉斯算子
...
int main( int argc, char** argv )
{
	...
	namedWindow( "【效果图】Laplacian边缘检测", CV_WINDOW_AUTOSIZE );

	// 创建trackbar
	createTrackbar( "参数值：", "【效果图】Canny边缘检测", &g_cannyLowThreshold, 120, on_Canny );
	createTrackbar( "参数值：", "【效果图】Sobel边缘检测", &g_sobelKernelSize, 3, on_Sobel );
	createTrackbar( "参数值：", "【效果图】Laplacian边缘检测", &g_LaplacianKernelSize, 3, on_Laplacian );
...
void on_Laplacian(int, void*)
{
	...
	imshow("【效果图】Laplacian边缘检测", g_dstImage);
